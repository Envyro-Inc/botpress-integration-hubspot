...
declare const ZuiForm: <UI extends UIComponentDefinitions = DefaultComponentDefinitions>({ schema, components, onChange, value, disableValidation, fallback, }: ZuiFormProps<UI>) => JSX.Element | null;
