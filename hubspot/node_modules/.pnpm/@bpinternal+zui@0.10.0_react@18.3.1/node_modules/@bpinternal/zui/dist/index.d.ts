...
type EmptyComponentDefinitions = {
    number: {};
    string: {};
    boolean: {};
    object: {};
...
type ZuiReactComponentBaseProps<Type extends BaseType, ID extends keyof UI[Type], UI extends UIComponentDefinitions = EmptyComponentDefinitions> = {
    type: Type;
    componentID: ID;
...
type ZuiReactDiscriminatedUnionComponentProps<Type extends ContainerType, ID extends keyof UI[Type], UI extends UIComponentDefinitions = EmptyComponentDefinitions> = ZuiReactComponentBaseProps<Type, ID, UI> & {
...
type ZuiReactObjectComponentProps<Type extends ContainerType, ID extends keyof UI[Type], UI extends UIComponentDefinitions = EmptyComponentDefinitions> = ZuiReactComponentBaseProps<Type, ID, UI> & {
    children: JSX.Element | JSX.Element[];
};
type ZuiReactArrayComponentProps<Type extends ContainerType, ID extends keyof UI[Type], UI extends UIComponentDefinitions = EmptyComponentDefinitions> = ZuiReactComponentBaseProps<Type, ID, UI> & {
    children: JSX.Element | JSX.Element[];
    addItem: (initialData?: any) => void;
    removeItem: (index: number) => void;
};
type ZuiReactControlComponentProps<Type extends BaseType, ID extends keyof UI[Type], UI extends UIComponentDefinitions = EmptyComponentDefinitions> = ZuiReactComponentBaseProps<Type, ID, UI> & {
    description?: string;
    required: boolean;
    config: any;
};
type ZuiReactComponentProps<Type extends BaseType, ID extends keyof UI[Type], UI extends UIComponentDefinitions = EmptyComponentDefinitions> = Type extends 'object' ? ZuiReactObjectComponentProps<Type, ID, UI> : Type extends 'array' ? ZuiReactArrayComponentProps<Type, ID, UI> : Type extends 'discriminatedUnion' ? ZuiReactDiscriminatedUnionComponentProps<Type, ID, UI> : ZuiReactControlComponentProps<Type, ID, UI>;
type ZuiReactComponent<Type extends BaseType, ID extends keyof UI[Type], UI extends UIComponentDefinitions = EmptyComponentDefinitions> = FC<ZuiReactComponentProps<Type, ID, UI>>;
type ZuiComponentMap<UI extends UIComponentDefinitions = EmptyComponentDefinitions> = {
    [T in BaseType]: {
...
declare abstract class ZodType<Output = any, Def extends ZodTypeDef = ZodTypeDef, Input = Output> {
     ...
     */
    displayAs<UI extends UIComponentDefinitions = EmptyComponentDefinitions, Type extends BaseType = ZodKindToBaseType<this['_def']>>(options: ParseSchema<UI[Type][keyof UI[Type]]>): this;
    /**
...
declare function withErrorBoundary<P = any>(Component: FC<P>, fallback?: BoundaryFallbackComponent): (props: P & ErrorBoundaryProps) => React.JSX.Element;

type ZuiFormProps<UI extends UIComponentDefinitions = EmptyComponentDefinitions> = {
    schema: JSONSchema;
...
declare const ZuiForm: <UI extends UIComponentDefinitions = EmptyComponentDefinitions>({ schema, components, onChange, value, disableValidation, fallback, dataTransform, onValidation, }: ZuiFormProps<UI>) => JSX.Element | null;

declare const defaultComponentDefinitions: {
    readonly string: {};
    readonly number: {
        readonly slider: {
            readonly id: "slider";
            readonly params: z.ZodObject<{}, "strip", z.ZodTypeAny, {}, {}>;
        };
    };
    readonly boolean: {
        readonly switch: {
...
type DefaultComponentDefinitions = typeof defaultComponentDefinitions;
